<%@ Page Title="My Courses" Language="C#" EnableEventValidation="false" MasterPageFile="InstructorPage.Master" AutoEventWireup="true" CodeBehind="InstructorCourses.aspx.cs" Inherits="Academy.WebForm6" %>
            ...
            <div class="table-wrapper">
                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="#addEmployeeModal" data-target="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Course</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtOverView" class="form-control" runat="server" TextMode="MultiLine"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="#CC3300" ErrorMessage="This field is required." Display="Dynamic" ValidationGroup="ba" ControlToValidate="txtOverView"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
